...
USER_INFO_THEME_PROMPT_COLOR=33 #jfisherr
...
SCM_THEME_PROMPT_UNSTAGED_COLOR=19 #git
...
CWD_THEME_PROMPT_COLOR=92 #directorios 

LAST_STATUS_THEME_PROMPT_COLOR=88 #salida de error
